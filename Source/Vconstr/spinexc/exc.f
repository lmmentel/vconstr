...
c
      character*8 scftyp,restr,unrestr
      data restr,unrestr/'rest','unrest'/
c
      call prep99
...
c     
     ...
     + '' integration :'',i5)')npold-1
      write(6,'('' total number of gridpoints :'',i5)')npnt
c    
      call ebrain(norb,npnt,npold,nspin,idmp,ismo,isks,isao,
     + atmol4)
c     
      call revind
      call secsum
...
c     ip >  0  : it was item ip of the list
      ...
      data cnt/ 'title','dmpfile','adapt','spin','enter' /
      call reada(word)
