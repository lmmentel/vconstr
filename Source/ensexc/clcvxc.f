...
c
     ...
     + d2rho(npntmx,6,nspin),vxc(npntmx,nspin,7),exc(npntmx,7)
c
...
c
      dum=1.d0
      call xcpot(nspin,npnt,npntmx,rho,1,dum,vxc(1,1,1),vxc(1,1,2))
